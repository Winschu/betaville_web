...
<head>
    ...
    <script src="js/libs/geojson-vt-dev.js"></script>
    <script src="js/libs/L.CanvasTiles.js"></script>
...
<!-- JavaScripts -->
<script src="js/libs/Front/jquery-2.2.4.min.js"></script>
...
<script>
    ...
    $('#dropnoClose').bind('click', function (e) {
        e.stopPropagation();
    });
    ...
    function getMapData(e) {
        ...
        $.ajax({
            url: 'http://overpass-api.de/api/interpreter?data=[out:json];(' + node + way + relation + ');out;>;out skel qt;',
            dataType: 'json',
            type: 'GET',
            async: true,
            crossDomain: true,
