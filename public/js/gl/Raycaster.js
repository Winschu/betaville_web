...
function Raycaster() {
    thatRay = this;
    this.geoClickPosMarker(); //TODO: Does this call works?
...
Raycaster.prototype.onclickAction = function (event, flag, camera) {
    ...
    if (intersects.length > 0) {
        ...
        if (group[0] === ("Build" || "Proposal" || "GeoPosition" || "GeoGround" || 'ProposalObj' || 'buildingsLow')) //TODO: Does this call works?
        {
            if (thatGUI._guiOpenName === '') {
                this.showGUI(group[0], intersects[0], thisCore.mouse.button);
            } else if (thatGUI._guiOpenName !== '') {
