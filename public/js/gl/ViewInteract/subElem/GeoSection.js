...
GeoSection.prototype.openSubElem = function (elem) {
    ...
    } else if (elem === 'addCityObj') {
        this.addCityobjBody.style.display = 'block';
    } else if (elem === 'addgeoPosition') {
...
GeoSection.prototype.createAddCityObj = function () {
    ...
    this.uploadCityFile(); //TODO: Does this function call works? Former notation was without brackets.
    this.uploadCityObj = {
        'object': '',
        'type': ''
    };

    this.uploadCityObjTexture = [];
    this.uploadCityFileTexture = []; //TODO: Is unused
    ...
    var totalProgress = 0; // Enthält den aktuellen Gesamtfortschritt //TODO: Is unused
    var currentUpload = null; // Enthält die Datei, die aktuell hochgeladen wird //TODO: Is unused
